...
function onCreate()
  ...
  makeLuaSprite('tabihealthbar3', 'hud/healthbarloveweeksadness', 0, 500)
	setObjectCamera('tabihealthbar3', 'hud')
	scaleObject('tabihealthbar3', 0.95, 0.95);
	addLuaSprite('tabihealthbar3', true)
  setProperty('tabihealthbar3.visible', true)

  makeLuaSprite('tabihealthbar2', 'hud/healthbarloveweek', 0, 500)
	setObjectCamera('tabihealthbar2', 'hud')
	scaleObject('tabihealthbar2', 0.95, 0.95);
...
function onCreatePost()
  ...
  setProperty('tabihealthbar.visible', true)
  setProperty('blackthing.visible', false)
  setProperty('foreverScore.visible', false)
  setProperty('tabihealthbar.visible', false)
  ...
  setProperty('tabihealthbar2.x', getProperty('healthBar.x') - 70)
...
getProperty("iconP2.visible", true)

if curStep == 256 then

 doTweenAlpha('iconphase', 'iconP2', 0.7, 4, 'linear')

end

if curStep == 507 then

  doTweenAlpha('iconphase', 'iconP2', 0.5, 4, 'linear')
 ...
 if curStep == 768 then
  ...
  doTweenAlpha('iconphase', 'iconP2', 0.3, 4, 'linear')
 
 end

 if curStep == 1280 then

  doTweenAlpha('iconphase', 'iconP2', 0, 4, 'linear')
