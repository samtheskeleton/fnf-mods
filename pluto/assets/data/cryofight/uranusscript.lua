...
idle_xml_name = 'uranus idle'
left_xml_name = 'uranus left'
down_xml_name = 'uranus down'
up_xml_name = 'uranus up'
right_xml_name = 'uranus right'
...
name_of_character_xml = 'uranus'
name_of_character = 'uranus'
name_of_notetype = 'uranus'
...
function onCreate()
	...
	addAnimationByPrefix(name_of_character, 'idle', idle_xml_name, 16, false);
	addAnimationByPrefix(name_of_character, 'singLEFT', left_xml_name, 16, false);
	addAnimationByPrefix(name_of_character, 'singDOWN', down_xml_name, 16, false);
	addAnimationByPrefix(name_of_character, 'singUP', up_xml_name, 16, false);
	addAnimationByPrefix(name_of_character, 'singRIGHT', right_xml_name, 16, false);
